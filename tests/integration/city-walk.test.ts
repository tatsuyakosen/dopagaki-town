...
import { movementVector, frameSeconds } from "../../apps/game-client/src/walk/movement.js";
...
describe("walking controls",()=>{
  ...
  it("clamps tab-resume deltas",()=>{expect(frameSeconds(10000)).toBe(.04);expect(frameSeconds(-1)).toBe(0);});
});
